...
Existem diversos tipos de diagramas UML e eles são dividos em duas categorias: os estruturais e os comportamentais. A \Figura{fig:umloverview} representa os tipos de diagrama de cada uma das categorias.
